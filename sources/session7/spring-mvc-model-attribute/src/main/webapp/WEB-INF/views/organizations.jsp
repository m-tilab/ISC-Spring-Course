    ...
    <table class="table table-striped">
        ...
        <c:forEach var="organization" items="${organizations}">
            <tr>
                ...
                <td>
                    <a href="${contextPath}/organization/editOrganization?organizationId=${organization.id}">Edit</a>
                    <a href="${contextPath}/organization/organizations/${organization.id}">Delete</a>
                </td>
            </tr>
