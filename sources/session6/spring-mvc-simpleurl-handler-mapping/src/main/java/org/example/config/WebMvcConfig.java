...
import org.example.controller.OrganizationController;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public SimpleUrlHandlerMapping simpleUrlHandlerMapping() {
        ...
        var urlMap = new HashMap<String, Object>();

        urlMap.put("/organization-simple-url", viewOrganization());
    ...
    @Bean
    public OrganizationController viewOrganization() {
