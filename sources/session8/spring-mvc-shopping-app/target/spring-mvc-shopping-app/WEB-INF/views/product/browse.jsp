    ...
    <table class="table table-striped">
        ...
        <c:forEach var="product" items="${products}">
            <tr>
                ...
                <td>
                    <c:out value="${productCategoryService.getProductCategory(product.productCategoryId).getName()}"/>
                </td>
                <td>
                ...
                <td>
                    ...
                    <a href="${contextPath}/addToCard?productId=${product.productId}">add to card</a>
                </td>
            </tr>
